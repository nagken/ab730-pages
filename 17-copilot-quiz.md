# Practice AB-730 with Microsoft Copilot
...
<div class="qz-grid" id="qzGrid">
  <a class="qz-card" data-prompt="You are a Microsoft AB-730 (AI Business Professional) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, tell me if I am right, give the correct answer, and a 2-3 line explanation tied to official Microsoft Learn. Cover all AB-730 domains: Generative AI Fundamentals (LLM basics, hallucinations, responsible AI six principles, Microsoft Copilot vs Microsoft 365 Copilot vs Copilot Studio); Manage Prompts and Conversations (GCSE pattern, iteration, anti-patterns, sensitivity labels); Draft and Analyze Business Content (Copilot in Word/Excel/PPT/Outlook/Teams, citations, structured tables in Excel). Do not show the answer until I commit. Start with question 1 now." data-target="copilot" href="#"><span class="qz-eyebrow">Full exam mode</span><h3>Sequential Practice Exam</h3><p>Exam-style questions across every AB-730 domain. One at a time, with a Microsoft Learn-grounded explanation.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="Microsoft AB-730 rapid-fire mode: ask me 20 short multiple-choice questions, one at a time. After each I answer, give one-line correctness and the right answer. At the end give my score and the 3 weakest topics with Microsoft Learn links to study. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Speed round</span><h3>Rapid-Fire (20 questions)</h3><p>Twenty short multiple-choice items back-to-back. Final score plus a ranked list of your three weakest topics with study links.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-730 coach. Drill me on Microsoft Copilot tool selection. Give a real-world business scenario and 4 plausible Microsoft Copilot tools (Microsoft Copilot free, Microsoft Copilot Pro, Microsoft 365 Copilot, Copilot Studio, GitHub Copilot, Copilot for Sales/Service/Finance). Wait for my answer, then explain why the right tool wins and why the others are traps. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Tool selection</span><h3>Decision-Tree Drills</h3><p>"Which Copilot tool?" scenarios with four plausible options. Distractors explained, not just the right answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-730 coach. Quiz me on the 50 most common 'gotchas' on the exam (e.g. M365 license alone is not enough for Copilot, Copilot Pro is consumer-only, Excel needs structured tables, sensitivity labels propagate to output). One at a time, multiple choice, then explanation. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Trick questions</span><h3>Gotcha and Trap Drill</h3><p>The 50 most-confused exam distinctions: license vs feature, web vs tenant grounding, structured vs unstructured data.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-730 prompt-engineering coach. Give me one weak prompt at a time. I will rewrite using the GCSE pattern (Goal, Context, Source, Expectations). You critique my rewrite and give the model answer. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Prompt critique</span><h3>Prompt Rewrite Critique</h3><p>You rewrite weak prompts using GCSE; the coach critiques and gives the model answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="I just took the AB-730 practice exam. First ask me which 2 domains I want to drill (Generative AI Fundamentals / Manage Prompts and Conversations / Draft and Analyze Content). Then ask 10 deeper scenario questions on those domains with detailed explanations referencing Microsoft Learn. Begin by asking which domains." data-target="copilot" href="#"><span class="qz-eyebrow">Targeted study</span><h3>Weak-Area Deep Dive</h3><p>Tell Copilot the two domains you struggle with and get ten deeper scenario questions on those areas only.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
</div>

<div class="qz-alt">
  <button data-prompt="You are a Microsoft AB-730 (AI Business Professional) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, give correctness, the right answer, and a 2-3 line explanation grounded in Microsoft Learn. Cover Generative AI Fundamentals; Prompt Crafting (GCSE); Draft and Analyze Content with Copilot in M365 apps. Begin." data-target="gemini">Open same prompt in Google Gemini</button>
  <button data-prompt="You are a Microsoft AB-730 (AI Business Professional) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, give correctness, the right answer, and a 2-3 line explanation grounded in Microsoft Learn. Cover Generative AI Fundamentals; Prompt Crafting (GCSE); Draft and Analyze Content with Copilot in M365 apps. Begin." data-target="chatgpt">Open same prompt in ChatGPT</button>
  <button data-prompt="You are a Microsoft AB-730 (AI Business Professional) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, give correctness, the right answer, and a 2-3 line explanation grounded in Microsoft Learn. Cover Generative AI Fundamentals; Prompt Crafting (GCSE); Draft and Analyze Content with Copilot in M365 apps. Begin." data-target="claude">Open same prompt in Claude</button>
</div>
...
1. **Stay in one chat** for a full quiz - Copilot tracks score.
2. After 5-10 questions, type `score me so far`.
3. Type `harder, scenario-based` or `simpler, recall-only` to retune difficulty.
4. To target one domain, type `only ask about <domain name>`.
5. Type `cite the Microsoft Learn page` after any answer.
...
| --- | --- | --- |
| **Microsoft Copilot** | Unlimited chats with Microsoft account | Recommended starting point. |
| **Google Gemini** | Free tier with Google account | Optional second opinion. |
| **ChatGPT** | Free tier | Optional second opinion. |
| **Claude** | Free tier | Optional second opinion. |

> [!IMPORTANT]
> [Microsoft Learn](https://learn.microsoft.com) is the authoritative source for AB-730 content. Use any LLM as a study aid and verify on Microsoft Learn.
